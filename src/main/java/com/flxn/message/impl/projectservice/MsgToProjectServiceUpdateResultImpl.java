 ...
 */
public class MsgToProjectServiceUpdateResultImpl extends MsgToProjectService {

	public MsgToProjectServiceUpdateResultImpl(Address to, Address from, DeferredResponse deferredResponse) {
