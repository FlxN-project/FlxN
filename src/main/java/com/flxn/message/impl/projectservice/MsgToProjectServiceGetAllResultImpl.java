 ...
 */
public class MsgToProjectServiceGetAllResultImpl extends MsgToProjectService {
	public MsgToProjectServiceGetAllResultImpl(Address to, Address from, DeferredResponse deferredResponse) {
