 ...
 */
public class MsgToProjectServiceDeleteResultImpl extends MsgToProjectService {

	public MsgToProjectServiceDeleteResultImpl(Address to, Address from, DeferredResponse deferredResponse) {
